...
import {Tenant} from "../../../hooks/useTenantsData.ts";
...
export default function TenantFormDialog({open, onClose, data, onCreate, onEdit}: ITenantFormDialog) {
    ...
    const onSubmit: SubmitHandler<Inputs> = (formData) => {
        ...
        const tenant: Tenant = {...formData, created}
    ...
    return (
        <DataDialog title={"Tenant Form"} open={open} onClose={onClose} onSubmit={handleSubmit(onSubmit)}>
